...
import { CheckCircle, XCircle, AlertTriangle, FileText, Camera, Upload, TrendingUp, Clock, Users, BarChart } from "lucide-react";
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {['John Smith', 'Sarah Johnson', 'Mike Wilson', 'Emma Davis'].map((inspector) => (
                    <div key={inspector} className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium">{Math.floor(Math.random() * 50) + 20} inspections</p>
                        <p className="text-xs text-muted-foreground">{Math.floor(Math.random() * 5) + 95}% accuracy</p>
                      </div>
                    </div>
                  ))}
                </div>
