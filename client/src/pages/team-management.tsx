...
// Advanced User Edit Form Component with comprehensive employee data
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-blue-50 p-3 rounded-md text-sm">
        <strong>Note:</strong> This will update the user account and create/update the linked employee profile. 
